...
CLASS_DICT_PATH = "/home/connor/Dev/segmentation_research/segmentation_research/experiments/ade20k/classes.csv"

# Image size that we are going to use
IMG_SIZE = 473 # 192 (small/fast) or 473 (original PSPNet)
